      ...
      <div className="bg-zinc-800/90 backdrop-blur-md p-8 rounded-xl shadow-lg max-w-sm w-full text-center border border-zinc-700/50">
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            className="bg-zinc-600/80 cursor-pointer hover:bg-zinc-600 text-red-400 px-6 py-2 rounded-lg font-semibold backdrop-blur-sm"
          >
            Yes, Delete
          </button>
          <button
            onClick={handleCancelDelete}
            className="bg-zinc-600/80 hover:bg-zinc-600 cursor-pointer text-white px-6 py-2 rounded-lg font-semibold backdrop-blur-sm"
          >
            Cancel
          </button>
        </div>
