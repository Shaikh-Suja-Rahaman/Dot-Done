  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex flex-col justify-center items-center w-1/2 text-white bg-[#1a1a1a] border-r border-zinc-800">
        ...
        />
        <p className="text-zinc-500 text-base mt-8 font-body tracking-wide">WELCOME BACK — SIGN IN TO CONTINUE</p>
      </div>
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-1/2 bg-[#151515] min-h-screen px-8">
        <form onSubmit={handleSignIn} className="bg-[#1a1a1a] p-10 shadow-2xl w-full max-w-md border border-zinc-800">
          <h2 className="text-3xl font-display font-bold text-green-400 mb-8 text-center tracking-tight">SIGN IN</h2>
          <p className="mb-8 text-center text-zinc-400 font-body text-sm tracking-wide">
            Don't have an Account?{' '}
            <Link to="/signup" className="text-green-400 hover:text-green-300 font-heading font-semibold transition-colors tracking-wide">SIGN UP</Link>
          </p>
